...
- [x] Explain what a token is used for.
  ...
  A: A token is used for making security decisions and for storing private information.

- [x] What steps can you take in your web apps to keep your data secure?

  A: Enforce strong passwords and encrypt login pages.

- [x] Describe how web servers work.

  A: The browser connects to the server, asks for a page, and the server sends back the requested page.
